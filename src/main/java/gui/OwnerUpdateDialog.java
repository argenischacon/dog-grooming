...
public class OwnerUpdateDialog extends javax.swing.JDialog {

    private static final Logger logger = LoggerFactory.getLogger(OwnerUpdateDialog.class);
    ...
    public OwnerUpdateDialog(java.awt.Frame parent, boolean modal, Long ownerId) {
        super(parent, modal);
    ...
    private void loadOwnerData() {
        ...
        //Disable form components to prevent editing while loading
        dniTextField.setEnabled(false);
        nameTextField.setEnabled(false);
        lastnameTextField.setEnabled(false);
        birthdateDateChooser.setEnabled(false);
        ...
        SwingWorker<OwnerDetailDto, Void> worker = new SwingWorker<OwnerDetailDto, Void>() {
            ...
            protected void done() {
                try {
                    ...
                    birthdateDateChooser.setEnabled(true);
    ...
    private void populateForm(OwnerDetailDto ownerDto) {
        ...
        lastnameTextField.setText(ownerDto.getLastname());
        if (ownerDto.getBirthdate() != null) {
            Date date = Date.from(ownerDto.getBirthdate().atStartOfDay(ZoneId.systemDefault()).toInstant());
            birthdateDateChooser.setDate(date);
        }
